    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
          ...
          body: JSON.stringify({
            websiteId: '38e0b973-4548-4ac6-bcd6-3d42cf5da428',
            name: data.name || '',
            email: data.email || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יהלומה התכשיטים הנדירים עבורך משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
